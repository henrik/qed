...
defmodule QEDWeb.PageView.Visualizer do
  use QEDWeb, :view
  ...
  defp render_name(name = :__aliases__), do: "<a href=\"https://hexdocs.pm/elixir/Kernel.SpecialForms.html#__aliases__/1\" class=\"doc-link\">#{inspect name}</a>"
  defp render_name(name = :.), do:           "<a href=\"https://hexdocs.pm/elixir/Kernel.SpecialForms.html#./2\" class=\"doc-link\">#{inspect name}</a>"
